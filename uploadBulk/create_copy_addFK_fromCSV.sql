...
\copy songs(name,length) FROM '/Users/jordan_bice/documents/hack-reactor/sdc/Postgres/testCases/songs_testData.csv' DELIMITER ',' CSV HEADER;
\copy comments(song_id,author,avatar,date_written,time_written,text_written) FROM '/Users/jordan_bice/documents/hack-reactor/sdc/Postgres/testCases/comments_testData.csv' DELIMITER ',' CSV HEADER;
